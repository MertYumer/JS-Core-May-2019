function solve() {
    ...
    nextButtonElement.addEventListener('click', nextClickEvent);
    cancelButtonElement.addEventListener('click', cancelClickEvent);
    ...
    function nextClickEvent() {
        if (nextButtonClicks == 0) {
            ...
            if (radioButtons[0].checked) {
                ...
                setTimeout(() => {
                    nextButtonElement.style.display = 'inline'
                }, 3000);
            }
